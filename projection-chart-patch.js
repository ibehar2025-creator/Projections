(function () {
  ...
  function installCssPatch() {
    ...
    style.textContent = `
      ...
      #valuation .tools-grid {
        grid-template-columns: repeat(auto-fit, minmax(280px, 1fr));
        align-items: stretch;
      }
      #valuation .tool-panel {
        display: flex;
        flex-direction: column;
        gap: 14px;
        min-width: 0;
      }
      #valuation .tool-panel h2,
      #valuation .tool-panel .tool-copy,
      #valuation .tool-panel .section-heading,
      #valuation .tool-panel .input-grid,
      #valuation .tool-panel .button-row,
      #valuation .tool-panel .answer-box,
      #valuation .tool-panel label,
      #valuation .tool-panel form {
        min-width: 0;
      }
      #valuation .tool-panel form {
        display: grid;
      ...
      #valuation .section-heading .small-muted {
        max-width: 360px;
        margin-left: auto;
        text-align: right;
      }
  ...
  function installCalculatorFixes() {
    ...
    const runButton = byId("runSp500");
    const form = byId("sp500Form");
    if (runButton && !runButton.dataset.runtimePatchBound && typeof renderSp500 === "function") {
      runButton.dataset.runtimePatchBound = "true";
    ...
    if (form && !form.dataset.runtimePatchBound && typeof renderSp500 === "function") {
      form.dataset.runtimePatchBound = "true";
